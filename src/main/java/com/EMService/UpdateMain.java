...
public class UpdateMain extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
			int c=d.update(id, name, age, gender, email, phno, salary);
			if(c==1) {
                ...
                dw.forward(req, resp);
				    ...
				    out.println("<p>The employee record could not be Updated. Please check the ID and try again.</p>");
				    out.println("<a href='Update.html' class='btn'>Retry</a>");
